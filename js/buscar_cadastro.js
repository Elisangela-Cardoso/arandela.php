var buscarCadastro = document.querySelector("#filtrar_cadastro");

buscarCadastro.addEventListener("input", function(){

    var info_clientes = document.querySelectorAll(".info_cliente")
